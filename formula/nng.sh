...
build() {
    cmakew \
        ...
        -DNNG_ENABLE_TLS=ON \
        -DNNG_ENABLE_HTTP=ON \
        -DMBEDTLS_TLS_LIBRARY="$mbedtls_LIBRARY_DIR/libmbedtls.a" \
        -DMBEDTLS_CRYPTO_LIBRARY="$mbedtls_LIBRARY_DIR/libmbedcrypto.a" \
        -DMBEDTLS_X509_LIBRARY="$mbedtls_LIBRARY_DIR/libmbedx509.a" \
