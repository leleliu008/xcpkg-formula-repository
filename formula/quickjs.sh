...
package set src.url "https://bellard.org/quickjs/quickjs-2021-03-27.tar.xz"
...
build() {
    makew clean &&
    makew install HOST_CC=$CC_FOR_BUILD CC="'$CC $CFLAGS $CPPFLAGS'" AR=$AR STRIP=$STRIP CROSS_PREFIX=xxx prefix="$TARGET_INSTALL_DIR"
}
